...
resource synapse 'Microsoft.Synapse/workspaces@2021-06-01' = {
  ...
  properties: {
    ...
    cspWorkspaceAdminProperties: {
      initialWorkspaceAdminObjectId: administratorObjectId
    }
...
resource synapsePrivateEndpointSql 'Microsoft.Network/privateEndpoints@2022-07-01' = {
...
resource synapsePrivateEndpointSqlARecord 'Microsoft.Network/privateEndpoints/privateDnsZoneGroups@2022-07-01' = if (!empty(privateDnsZoneIdSynapseSql)) {
...
resource synapsePrivateEndpointSqlOnDemand 'Microsoft.Network/privateEndpoints@2022-07-01' = {
...
resource synapsePrivateEndpointSqlOnDemandARecord 'Microsoft.Network/privateEndpoints/privateDnsZoneGroups@2022-07-01' = if (!empty(privateDnsZoneIdSynapseSql)) {
...
resource synapsePrivateEndpointDev 'Microsoft.Network/privateEndpoints@2022-07-01' = {
...
resource synapsePrivateEndpointDevARecord 'Microsoft.Network/privateEndpoints/privateDnsZoneGroups@2022-07-01' = if (!empty(privateDnsZoneIdSynapseDev)) {
