...
var datafactoryPrivateEndpointNameDatafactory = '${datafactory.name}-datafactory-pe'
var datafactoryPrivateEndpointNamePortal = '${datafactory.name}-portal-pe'
...
resource datafactoryPrivateEndpointDatafactory 'Microsoft.Network/privateEndpoints@2022-07-01' = {
  ...
  properties: {
    ...
    customDnsConfigs: []
    customNetworkInterfaceName: '${datafactoryPrivateEndpointNameDatafactory}-nic'
...
resource datafactoryPrivateEndpointDatafactoryARecord 'Microsoft.Network/privateEndpoints/privateDnsZoneGroups@2022-07-01' = if (!empty(privateDnsZoneIdDataFactory)) {
...
resource datafactoryPrivateEndpointPortal 'Microsoft.Network/privateEndpoints@2022-07-01' = {
  ...
  properties: {
    applicationSecurityGroups: []
    customDnsConfigs: []
    customNetworkInterfaceName: '${datafactoryPrivateEndpointNamePortal}-nic'
    manualPrivateLinkServiceConnections: []
    privateLinkServiceConnections: [
      {
        name: datafactoryPrivateEndpointNamePortal
...
resource datafactoryPrivateEndpointPortalARecord 'Microsoft.Network/privateEndpoints/privateDnsZoneGroups@2022-07-01' = if (!empty(privateDnsZoneIdDataFactoryPortal)) {
